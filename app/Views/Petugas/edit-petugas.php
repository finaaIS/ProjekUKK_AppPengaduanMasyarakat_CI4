...
<input type="text" name="txtInputtelp" class="form-control" placeholder="Masukan No Telphone petugas" value="<?=$detailPetugas[0]['telp'];?>" autocomplete="off" autofocous reaquire >
</div>
<div class="form-group">
