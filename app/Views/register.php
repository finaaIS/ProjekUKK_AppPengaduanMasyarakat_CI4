...
<html lang="en">
  <head>
	...
	<body class="img js-fullheight" style="background-image: url(images/gp.jpg);">
	<section class="ftco-section">
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-md-6 text-center mb-5">
					<h2 class="heading-section">From Registrasi Aplikasi Pengaduan Masyarakat Desa Jalaksana</h2>
				</div>
			</div>
			<div class="row justify-content-center">
				...
				<div class="form-group">
		      			<input name="txtTelp" maxlength="13" type="text" class="form-control" placeholder="Telp" required>
                    </div>
